...
$resourceGroupName = "simone-weatherapi-rg"

# Run the what-if deployment
az deployment group create --resource-group $resourceGroupName --template-file $bicepFilePath --parameters $parameterFilePath